  ...
  <div class="p-4 bg-white rounded-sm shadow-sm">
    ...
    <form method="POST" action="{{ route('project.update', $project) }}" autocomplete="off">
      ...
      <div class="mb-5">
        ...
        <input type="text" id="title" name="title" value="{{ $project->title }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
      </div>
      ...
      <div class="mb-5">
        ...
        <textarea rows="16" id="summary" name="summary" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">{{ $project->summary }}</textarea>
      </div>
      ...
      <div class="mb-5">
        ...
        <input type="text" id="keywords" name="keywords" value="{{ $project->keywords }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
      </div>
